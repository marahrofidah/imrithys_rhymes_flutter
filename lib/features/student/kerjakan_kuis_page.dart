...
class _KerjakanKuisPageState extends State<KerjakanKuisPage> {
  ...
  final List<Map<String, dynamic>> _babList = [
    ...
    {'key': 'bab_irab', 'label': "Bab I'rab – باب الإعراب", 'number': 3},
    {
      'key': 'bab_alamat_irab',
    ...
    {
      'key': 'bab_irab_fiil',
      'label': 'Bab I\'rab Fiil – باب إعراب الفعل',
      'number': 11,
    },
    {
    ...
    },
    {
      ...
      'label': 'Bab Dzanna dan Saudaranya – باب ظن وأخواتها',
      'number': 17,
    },
    {'key': 'bab_naat', 'label': 'Bab Na\'at – باب النعت', 'number': 18},
    {'key': 'bab_ataf', 'label': 'Bab Ataf – باب العطف', 'number': 19},
    ...
    {'key': 'bab_masdar', 'label': 'Bab Masdar – باب المصدر', 'number': 23},
    {'key': 'bab_dhorof', 'label': 'Bab Dhorof – باب الظرف', 'number': 24},
    {'key': 'bab_hal', 'label': 'Bab Hal – باب الحال', 'number': 25},
    {'key': 'bab_tamyiz', 'label': 'Bab Tamyiz – باب التمييز', 'number': 26},
    {
      'key': 'bab_istitsna',
    ...
    {'key': 'bab_munada', 'label': 'Bab Munada – باب النداء', 'number': 29},
    {
    ...
    {'key': 'bab_idofah', 'label': 'Bab Idofah – باب الإضافة', 'number': 33},
  ];
